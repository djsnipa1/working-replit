# working 🗃️
I'm using this as a `working` directory to get my __replit__ and __nix__ configuration buttoned up. 

> 📝 Notes will be here as time has showed me what a bitch it is when I don't keep good notes!
